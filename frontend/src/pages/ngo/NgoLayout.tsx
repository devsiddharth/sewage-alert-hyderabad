import { Award, BarChart3, Calendar, HeartHandshake, Home, IndianRupee, Map, Truck, UserRound } from "lucide-react";
...
export function NgoLayout() {
  ...
  return <AppShell navItems={nav} footerItems={footer} accent="admin" profilePath="/ngo/profile" />;
}
